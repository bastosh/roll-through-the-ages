...
export const DEVELOPMENTS = [
  { id: 'leadership', name: 'Leadership', cost: 10, points: 2 },
  { id: 'irrigation', name: 'Irrigation', cost: 10, points: 2 },
  { id: 'agriculture', name: 'Agriculture', cost: 15, points: 3 },
  { id: 'quarrying', name: 'Carrière', cost: 15, points: 3 },
  { id: 'medicine', name: 'Médecine', cost: 15, points: 3 },
  { id: 'coinage', name: 'Monnaie', cost: 20, points: 4 },
  { id: 'caravans', name: 'Caravanes', cost: 20, points: 4 },
  { id: 'religion', name: 'Religion', cost: 25, points: 6 },
  { id: 'granaries', name: 'Greniers', cost: 30, points: 6 },
  { id: 'masonry', name: 'Maçonnerie', cost: 30, points: 6 },
  { id: 'engineering', name: 'Ingénierie', cost: 40, points: 6 },
  { id: 'architecture', name: 'Architecture', cost: 50, points: 8 },
  { id: 'empire', name: 'Empire', cost: 60, points: 8 }
];
