...
const BASE_DEVELOPMENTS = [
  ...
  { id: 'forestry', discount: 'market', cost: 10, points: 2 },
  { id: 'agriculture', discount: 'village', cost: 15, points: 2 },
  { id: 'quarrying', discount: 'mine', cost: 15, points: 2 },
  ...
  { id: 'commerce', prerequisite: 'metropolis', discount: 'market', cost: 40, points: 8, scoringMultiplier: 1 }, // 1 point per remaining good
