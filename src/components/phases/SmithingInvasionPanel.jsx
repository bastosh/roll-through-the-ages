...
export default function SmithingInvasionPanel({
  ...
  return (
    <div className="bg-gradient-to-r from-orange-50 to-red-50 border-2 border-orange-400 rounded-lg p-4 mb-3">
      ...
      <div className="flex gap-2">
        {maxSpearheads > 0 && spearheadsToSpend > 0 ? (
          <button
            onClick={onConfirm}
            className="flex-1 py-3 px-4 rounded-lg font-bold text-lg bg-red-600 text-white hover:bg-red-700 transition shadow-md hover:shadow-lg cursor-pointer"
          >
          ...
          <button
            onClick={onSkip}
            className="flex-1 py-3 px-4 rounded-lg font-bold text-lg bg-orange-600 text-white hover:bg-orange-700 transition shadow-md hover:shadow-lg cursor-pointer"
          >
